...
public class GoCampingDTO {
	...
	public GoCampingDTO(String manager_id, String facltNm, String lineIntro, String intro, String bizrno,
	...
	public String toString() {
		return "GoCampingDTO [manager_id=" + manager_id + ", facltNm=" + facltNm + ", lineIntro=" + lineIntro
				+ ", intro=" + intro + ", bizrno=" + bizrno + ", facltDivNm=" + facltDivNm + ", featureNm=" + featureNm
				+ ", induty=" + induty + ", lctCl=" + lctCl + ", doNm=" + doNm + ", addr1=" + addr1 + ", mapX=" + mapX
				+ ", mapY=" + mapY + ", tel=" + tel + ", homepage=" + homepage + ", operPdCl=" + operPdCl
				+ ", operDeCl=" + operDeCl + ", sbrsCl=" + sbrsCl + ", firstImageUrl=" + firstImageUrl + "]";
	}
