...
//		System.out.println(selectFileInfo);
	...
	public String write(@RequestParam("category") String category,ServiceCenterDTO service,HttpSession session) throws IllegalStateException, IOException {
	...
	public String managerwrite(@RequestParam("category") String category,ServiceCenterDTO service,HttpSession session) throws IllegalStateException, IOException {
		System.out.println("service=>"+service);
		//1. MultipartFile정보를 추출하기
		List<MultipartFile> files = service.getFiles();
...
//		System.out.println(service);
	...
	public String delete(@RequestParam(value = "category",required = false) String category,String service_no,HttpSession session)throws IOException {
		//로그인한 사용자를 찾는다.
