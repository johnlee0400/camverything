		...
		<div id="topend" class ="col-lg-12">
			...
			<div class="col-lg-2">
				<nav>
					...
					<a href="/camp/login.do"><span class="glyphicon glyphicon-log-in">
							</span>Login</a></li>
						</ul>
					...
					<c:otherwise>
						...
						<li><a href="/camp/spring/logout"><span class="glyphicon glyphicon-log-out"></span>
								Logout</a></li>
					</ul>
...
<!-- 	                    <li><a href="/camp/login.do">로그인</a></li> -->
