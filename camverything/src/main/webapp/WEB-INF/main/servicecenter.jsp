			...
			function() {
				...
				$("#category").change(
						function() {
							...
							location.href = "/camp/service/list.do?category="
									+ encodeURI($(this).val())
						});
			});
	$(document).ready(
...
<body>
	...
	<div class="location">
		<div class="submenu">
			<ul id="category">
				<li class="selectbox" id="active"><a href="/camp/service/list.do?category=공지사항" class="link">공지사항</a></li>
				<li class="selectbox" ><a href="/camp/service/list.do?category=예약문의" class="link" >예약문의</a></li>
				<li class="selectbox"><a href="/camp/service/list.do?category=상품문의" class="link">상품문의</a></li>
			</ul>
		</div>
	</div>
