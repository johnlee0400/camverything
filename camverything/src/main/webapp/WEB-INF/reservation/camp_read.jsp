...
<style type="text/css">
    ...
    .info .title {padding: 5px 0 0 10px;height: 30px;background: #ADD8E6;border-bottom: 1px solid #ddd;font-size: 18px;font-weight: bold;}
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		//
		$("#div1").load("https://map.kakao.com/link/to/카카오판교오피스,37.402056,127.108212");
		...
		$(".onselect").on("change", function() {
			...
			$.ajax({
    			...
    			success:function(list){
					...
					console.log("total bbq다음=>"+$("#total").text());
					//세자리마다 콤마넣기
...
<div class="subcontainer">
	...
	<div class="mapAPI">
		...
		<div id="map" style="width: 1200px; height: 800px;"></div>
			<script type="text/javascript"
				src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2eab02a4a684e29b601c8b338c17388f&libraries=LIBRARY"></script>
			<script>
			//지도생성
				...
				var marker = new kakao.maps.Marker({
				    map: map, 
				    position: new kakao.maps.LatLng(${dto.mapY}, ${dto.mapX})
				});
				...
				var content = '<div class="wrap">' + 
				            ...
				            '        <div class="body">' + 
				            '            <div class="img">' +
				            '                <img src="${dto.firstImageUrl}" width="73" height="70">' +
				            '           </div>' + 
				            '            <div class="desc">' + 
				            '                <div class="ellipsis">${dto.addr1}</div>' + 
				            '				 <div class="jibun ellipsis">${dto.tel}</div>' + 
